...
def run_test_sum_more_cosines():
    ...
    # Test 4:
    expected = -0.399804  # This is APPROXIMATELY the correct answer.
    answer = sum_more_cosines(3, 6)
    print('Test 4 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 5:
    expected = -0.181629  # This is APPROXIMATELY the correct answer.
    answer = sum_more_cosines(-10, -6)
